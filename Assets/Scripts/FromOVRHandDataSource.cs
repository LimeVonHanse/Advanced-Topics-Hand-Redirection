...
namespace Oculus.Interaction.Input
{
    ...
    public class FromOVRHandDataSource : DataSource<HandDataAsset>
    {
        ...
        private void UpdateDataPoses(SkeletonPoseData poseData)
        {
            ...
            OVRPlugin.GetHeadPoseModifier(out rotation, out translation);

            UnityEngine.Vector3 hmdPosition;
            hmdPosition.x = translation.x;
            hmdPosition.y = translation.y;
            hmdPosition.z = translation.z;

            UnityEngine.Vector3 rawPosition = poseData.RootPose.Position.FromFlippedZVector3f();
            UnityEngine.Vector3 realDistance = rawPosition - hmdPosition;
            UnityEngine.Vector3 scaledDistance = realDistance * transformGain;

            UnityEngine.Vector3 fixedPosition = hmdPosition + scaledDistance;
...
#pragma warning restore 0618
        ...
        public void setTransformationGain(float gain)
        {
            transformGain = gain;
        }
    }
